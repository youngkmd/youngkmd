...
define('APP_TITLE', 'Volkan FileManager');

$dauth = false;

$auth_users = array(
    'admin' => 'dd9dfcf548b563b938fc8962675ffa9c',
    'user' => 'dd9dfcf548b563b938fc8962675ffa9c'
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="." target="_blank" class="app-v-title"> Vlkn <?php echo VERSION; ?></a></h3></p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="." target="_blank" class="float-right text-muted">Vlkn <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="." target="_blank" class="float-right text-muted">Vlkn <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Vlkn<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Vlkn">
    <meta name="author" content="Vlkn Programmers">
...
function lng($txt) {
    ...
    $tr['en']['AppName']        = 'Vlkn';      $tr['en']['AppTitle']           = 'Vlkn';
